...
public class StudentJsonController {
    ...
    @ResponseBody
    @RequestMapping(value = "/OneStudent3/{userName}",method = RequestMethod.GET,produces="application/json;charset=UTF-8")
    public String getUserInfo(@PathVariable("userName") String userName){
        if(userName.equals("zhangsan") ){
            Student getUser = new Student();
            getUser.setSname("zhangsan");
            getUser.setSsex("男");
